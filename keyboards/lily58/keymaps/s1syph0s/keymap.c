 ...
 */
[_LOWER] = LAYOUT(
  CLR    , KC_F1  , KC_F2,   KC_F3,   KC_F4 ,  KC_F5,                     KC_F6  , KC_F7  ,  KC_F8  , KC_F9  , KC_F10 , _______,
...
#define KC_A_UML UP(A_UML, A_UMLSHFT)
#define KC_U_UML UP(U_UML, U_UMLSHFT)
#define KC_O_UML UP(O_UML, O_UMLSHFT)
#define KC_S_UML UM(S_UML)
 ...
 */
  ...
  _______,KC_A_UML,KC_S_UML, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, KC_PGDN, KC_PGUP, XXXXXXX, XXXXXXX, KC_MUTE,
